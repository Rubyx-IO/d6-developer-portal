...
The data model, including the name of the variables for each table in the warehouse, their description and standard values is available [here](https://docs.google.com/spreadsheets/d/1xF58QDPaE-rKDAicDCf12dMqi8x1RhhGAItdx7Nk_QA/edit?usp=sharing). Please note that permission is required to access this document.
